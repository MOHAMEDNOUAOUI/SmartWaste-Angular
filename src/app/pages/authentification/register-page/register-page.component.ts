...
import { RegisterFeatureComponent } from "../../../features/Authentification/register-feature/register-feature.component";

@Component({
  selector: 'app-register-page',
  imports: [RouterModule, AuthLogoComponent, RegTextComponent, FormRegisterComponent, LoginExternComponent],
